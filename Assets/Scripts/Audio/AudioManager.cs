...
public class AudioManager : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip TutorialDialogue; //la del dialeg amb el monje bo
    [SerializeField] private AudioClip TutorialFailed; //la del dialeg amb el monje dolent
